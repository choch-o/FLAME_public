...
def powerSensorsPresent():
    ...
    return os.path.isdir('/sys/bus/i2c/drivers/ina3221x/1-0041/iio_device/')
...
def readValue(i2cAddr='0041', channel='0', valType='power'):
    ...
    fname = '/sys/bus/i2c/drivers/ina3221x/1-%s/iio_device/in_%s%s_input' % (i2cAddr, valType, channel)
