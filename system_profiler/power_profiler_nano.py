...
def powerSensorsPresent():
    ...
    return os.path.isdir('/sys/bus/i2c/drivers/ina3221x/6-0040/iio_device/')
...
def readValue(i2cAddr='0041', channel='0', valType='power'):
    ...
    fname = '/sys/bus/i2c/drivers/ina3221x/6-%s/iio_device/in_%s%s_input' % (i2cAddr, valType, channel)
